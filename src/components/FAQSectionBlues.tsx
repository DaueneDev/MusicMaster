...
export const FAQSection = () => {
  const faqs = [
    ...
    {
      question: '4. Eu sou iniciante. Posso aprender blues?',
      answer:
        'Sim. O blues é uma ótima base para qualquer guitarrista. Você começa no básico e evolui com exercícios e músicas progressivas.',
    },
    {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Tens dúvidas sobre nossas aulas de guitarra blues? Encontre respostas para as perguntas mais comuns abaixo.
          </p>
        </div>
