...
export const FAQSection = () => {
  ...
  },
 {
    ...
    question: '10. Posso usar guitarra acústica para praticar?',
    answer: 'Podes, sim 👍. Embora o curso seja voltado para guitarra elétrica, muitos exercícios podem ser feitos numa acústica. A diferença é que o som e algumas técnicas ficam melhores na elétrica.'
  },
{
  ...
  return <section id="faq" className="py-16 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
            ...
            Tens dúvidas sobre nossas aulas de guitarra elétrica? Encontre respostas para as perguntas mais comuns abaixo.
            </p>
        </div>
