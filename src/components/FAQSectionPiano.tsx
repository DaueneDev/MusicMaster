...
export const FAQSection = () => {
  const faqs = [
    ...
    question: '3. Preciso já ter um piano ou teclado para começar?',
    answer: "Não é obrigatório. Podes começar acompanhando as aulas e praticando com teclados virtuais no computador ou até no telemóvel. Mas, para aproveitar melhor o curso, recomendamos ter um teclado ou piano, mesmo que seja simples."
  }, {
    question: '4. Posso aprender mesmo sem saber nada de música?',
  ...
  },
 {
    ...
    question: '10. O curso serve para crianças e adultos?',
    answer: 'Sim. As aulas são fáceis de seguir e qualquer pessoa pode aprender, seja criança, jovem ou adulto.'
  },
{
  ...
  return <section id="faq" className="py-16 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
            ...
            Tens dúvidas sobre nossas aulas de piano e teclado? Encontre respostas para as perguntas mais comuns abaixo.
            </p>
        </div>
