export const HeroSection = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('https://unsplash.com/photos/JS-l3dLb8eQ/download?force=true&w=1600')",
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-xl mb-8 text-white">
              Aprende blues do zero: bends, vibrato, pentatônica, licks e feeling.
              Um método prático para tocares com emoção e soar como um guitarrista de verdade.
            </p>
          ...
          <div className="md:w-1/2">
            <div className="relative">
              <div className="bg-white p-2 rounded-lg shadow-xl">
                <img
                  src="https://unsplash.com/photos/hUHzaiAHuUc/download?force=true&w=1200"
                  alt="Guitarrista tocando blues"
