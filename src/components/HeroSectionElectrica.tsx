        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-xl mb-8 text-white">
              Aprende a tocar guitarra elétrica do zero até avançado com aulas práticas, divertidas e fáceis de seguir.
              Domina os riffs, solos e músicas que sempre sonhaste tocar — no teu ritmo, no teu celular, tablet ou computador.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a
                href="https://wa.me/258844948189?text=Ol%C3%A1%2C%20quero%20come%C3%A7ar%20agora%20com%20o%20curso%20de%20Guitarra%20El%C3%A9ctrica."
                target="_blank"
          ...
          <div className="md:w-1/2">
            <div className="relative">
              <div className="bg-white p-2 rounded-lg shadow-xl">
                <img src="https://images.unsplash.com/photo-1711371307248-0412f8e4ff73?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb&dl=luke-madziwa-duK0BmhNLRI-unsplash.jpg" alt="Estudante aprendendo a tocar guitarra" className="rounded w-full h-auto" />
              </div>
