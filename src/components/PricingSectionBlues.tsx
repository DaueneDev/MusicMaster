      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#6b5240] max-w-3xl mx-auto">
            Aprenda guitarra blues com aulas gravadas de alta qualidade por um preço promocional. Acesso vitalício e o pagas apenas uma vez.
          </p>
        </div>

        <div className="max-w-3xl mx-auto">
          <div className="bg-[url('https://unsplash.com/photos/gioH4gHo0-g/download?force=true&w=1600')] bg-cover rounded-lg overflow-hidden shadow-xl">
            <div className="bg-black bg-opacity-70 p-8">
              <div className="text-center">
                <h3 className="text-3xl font-bold text-[#e8b05c] mb-6">Curso Completo de Guitarra Blues</h3>
                ...
                <ul className="mb-8 space-y-3 max-w-md mx-auto">
                  {[
                    'Pentatônica e blues scale',
                    'Licks clássicos e frases',
                    'Bends, vibrato e técnica',
                    'Ritmo shuffle e boogie',
                    'Acesso vitalício',
