      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#6b5240] max-w-3xl mx-auto">
            Aprenda contrabaixo com aulas gravadas de alta qualidade por um preço promocional.
            Acesso vitalício e o pagas apenas uma vez.
          </p>
        </div>

        <div className="max-w-3xl mx-auto">
          <div className="bg-[url('https://unsplash.com/photos/5OlBfj3Qgak/download?force=true&w=1600')] bg-cover rounded-lg overflow-hidden shadow-xl">
            <div className="bg-black bg-opacity-70 p-8">
              <div className="text-center">
                <h3 className="text-3xl font-bold text-[#e8b05c] mb-6">
                  Curso Completo de Contrabaixo
                </h3>
                ...
                <div className="bg-[#e8b05c] inline-block px-8 py-4 mb-6 rounded">
                  <div className="flex items-center justify-center gap-6">
                    ...
                    <span className="text-[#3c2415] text-4xl font-bold">250 MT</span>
                  </div>
                ...
                <ul className="mb-8 space-y-3 max-w-md mx-auto">
                  {[
                    'Grooves e levadas do básico ao avançado',
                    'Técnicas: dedilhado, palheta e slap',
                    'Teoria musical simplificada para baixistas',
                    'Treino de tempo e precisão com exercícios',
                    'Acesso vitalício',
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center">
                  <a
                    href="https://wa.me/258844948189?text=Ol%C3%A1%2C%20quero%20come%C3%A7ar%20agora%20com%20o%20curso%20de%20Contrabaixo."
                    target="_blank"
