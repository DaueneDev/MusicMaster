      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#6b5240] max-w-3xl mx-auto">
            Aprenda a tocar piano e teclado com aulas gravadas de alta qualidade por um preço promocional. Acesso vitalício e o pagas apenas uma vez. Não perca essa oportunidade de transformar sua paixão pela música em realidade!
          </p>
        </div>
            ...
            <div className="bg-black bg-opacity-70 p-8">
              <div className="text-center">
                <h3 className="text-3xl font-bold text-[#e8b05c] mb-6">
                  Curso Completo de Piano e Teclado
                </h3>
